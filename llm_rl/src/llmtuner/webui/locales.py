LOCALES = {
    ...
    "checkpoints": {"en": {"label": "Checkpoints"}, "zh": {"label": "模型断点"}},
    "refresh_btn": {
        "en": {"value": "Refresh checkpoints"},
        "zh": {"value": "刷新断点"},
    },
    "advanced_tab": {
    ...
    "system_prompt": {
        ...
        "zh": {"label": "系统提示词（非必填）", "info": "默认使用的系统提示词"},
    },
    "llama_tab": {
        "en": {"label": "Model configurations (LLaMA only)"},
        "zh": {"label": "模型设置（仅LLaMA）"},
    },
    "flash_attn": {
        "en": {"label": "Use FlashAttention-2"},
        "zh": {"label": "使用 FlashAttention-2"},
    },
    "shift_attn": {
        "en": {"label": "Use shift short attention (S^2-Attn)"},
        "zh": {"label": "使用 shift short attention (S^2-Attn)"},
    },
    "rope_scaling": {
    ...
    "dataset_dir": {
        "en": {"label": "Data dir", "info": "Path of the data directory."},
    ...
    "train_on_prompt": {
        ...
        "zh": {"label": "计算输入损失", "info": "在监督微调时候计算输入序列的损失。"},
    },
    "upcast_layernorm": {
        "en": {
        ...
        "zh": {"label": "缩放归一化层", "info": "将归一化层权重缩放至 32 位浮点数。"},
    },
    "lora_tab": {
    ...
    "output_dir": {
        ...
        "zh": {"label": "断点名称", "info": "保存模型断点的文件夹名称。"},
    },
    ...
    "max_shard_size": {
        ...
        "zh": {"label": "最大分块大小（GB）", "info": "模型文件的最大大小。"},
    },
...
ALERTS = {
    ...
    "err_no_checkpoint": {"en": "Please select a checkpoint.", "zh": "请选择断点。"},
