...
python3 /home/ruiyiwan/sotopia-llm/llm_self_train/pipelines/monitor_eval_and_stop_deploy.py --ckpt-name checkpoint-base_epoch_1 &

# Starting the controller
python3 -m fastchat.serve.controller &

# Starting the model worker with the specified model path
python3 -m fastchat.serve.model_worker --model-path /data/tir/projects/tir6/bisk/ruiyiwan/selftrain/pilot-1/checkpoint-base_epoch_1 &
